...
#(Tabela_1.1_OVADBE_SPOL_POLNOLETNI)
...
Tabela_3_OBSODBE_SPOL_POLNOLETNI$starost <- c(NA)
...
View(Tabela_4.1_OVADBE_moski_MLADOLETNI)
Tabela_4.1_OVADBE_moski_MLADOLETNI <- Tabela_4.1_OVADBE_moski_MLADOLETNI %>% melt(id.variable = "X1",
                                                                                  variable.name = "leto",value.name = "kolicina")
